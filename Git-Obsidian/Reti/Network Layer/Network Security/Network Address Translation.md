...
Maschera la rete privata utilizzando il [[../Routing/Routing#Ruolo del Gateway|gateway]].
...
- Agisce su indirizzi `IP` e [[../../Transport Layer/Livello di Trasporto#Numero di Porta|numeri di porta]].
...
>Il `NAT` può fornire anche conversione di indirizzo `IP` e porta [[../../Transport Layer/TCP]] o [[../../Transport Layer/UDP]].
...
>- [[../../Application Layer/FTP#Connessione Passiva|FTP]].
