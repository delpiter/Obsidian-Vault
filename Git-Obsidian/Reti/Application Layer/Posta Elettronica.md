...
![[attachements/Read-Email.png]]
#### Standard E-mail
> Il messaggio standard delle e-mail è in formato [[../../Architettura degli Elaboratori/Rappresentazione dell'Informazione/Rappresentazione dei Caratteri#ASCII|ASCII]].
...
> Il trasferimento delle informazioni avviene tramite connessione [[../Transport Layer/TCP]]:
> - Attraverso la [[../Transport Layer/Livello di Trasporto#Numero di Porta|porta]] $25$.

> I messaggi devono essere in formato [[../../Architettura degli Elaboratori/Rappresentazione dell'Informazione/Rappresentazione dei Caratteri#ASCII|ASCII]] a $7$ `bit`.
...
![[attachements/SMTP.png]]

### Protocolli di Accesso
---
#### POP3
>[!info]
>Il protocollo **POP3** (***P***ost ***O***ffice ***P***rotocol ***3***) [RFC 1939](https://www.rfc-editor.org/rfc/rfc1939.html) utilizza il protocollo di trasporto [[../Transport Layer/TCP]] sulla [[../Transport Layer/Livello di Trasporto#Numero di Porta|porta]] $110$ del server
> 
...
**IMAP** utilizza il protocollo ***TCP*** sulla [[../Transport Layer/Livello di Trasporto#Numero di Porta|porta]] $143$
## MIME
---
>[!tldr] MIME Types
