...
---
>[!tldr] Idea
>Lo strato `LLC` è indipendente dal mezzo fisico, dalla topologia e dal [[Networks/LAN#Accesso al Canale di Collegamento|protocollo di accesso]].

Lo strato `LLC` gestisce:
- Controllo del [[Controllo del Canale|canale]] e d'[[Controllo dell'Errore|errore]].
- [[../Introduzione/Multiplexing|Multiplexing]].
...
- [[../Network Layer/Reti IP#Broadcast|Broadcast]] (`ff-ff-ff-ff-ff-ff`).

In condizioni normali una [[Networks/LAN|LAN]] è anche un singolo dominio di broadcast.
...
L'[[../Prestazioni/Funzionalità e Prestazioni|efficienza]] pone un limite superiore al massimo traffico.
