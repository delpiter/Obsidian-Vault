...
---
>[!info]
>Sistema di ***posizionamento*** e ***navigazione*** basato su una *rete di satelliti*.
...
- Qualità del Ricevente.
- Effetti nella propagazione delle onde radio.

>[!caution] Principio di Funzionamento

I `GPS` si basano sul concetto di ***trilaterazione***.
- Si misura il tempo richiesto per ricevere un segnale dai satelliti.
